...
class Ego4DHdf5Dataset(IterableDataset):
    ...
    def __iter__(self):
        for f in self.files:
            ...
            num_audio_samples = int(self.duration * self.sample_rate)
            ...
            with h5py.open(fpath, 'r') as h5:
                ...
                num_valid_chunks = h5.attrs["num_valid_chunks"]
                ...
                total_audio_frames = h5.attrs["num_audio_frames"]
                total_video_frames = h5.attrs["num_video_frames"]
                ...
                if self.duration < full_duration:
                    ...
                    for chunk_idx in range(num_chunks):
                        start_ts = chunk_idx * self.chunk_duation
